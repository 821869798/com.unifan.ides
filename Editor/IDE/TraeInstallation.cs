...
{
    internal class TraeInstallation : CodeEditorInstallation
    {
        protected override string EditorName => "Trae";
        protected override string ExecutableName => "trae";
        protected override string WindowsExecutablePattern => ".*Trae.*\\.exe$";
        protected override string macOSAppPattern => ".*Trae.*\\.app$";
        protected override string LinuxDesktopFileName => "trae.desktop";

        protected override CodeEditorInstallation CreateInstallationInstance() => new TraeInstallation();
        ...
        {
            return new TraeInstallation().TryDiscoverInstallationInternal(editorPath, out installation);
        }

        public static IEnumerable<IVisualStudioInstallation> GetInstallations()
        {
            return new TraeInstallation().GetInstallationsInternal();
        }
